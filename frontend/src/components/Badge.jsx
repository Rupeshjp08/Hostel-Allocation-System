export default function Badge({ status, children, variant, className = '' }) {
  ...
  const variantStyles = {
    ...
    allocated: 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30',
    rejected: 'bg-rose-500/15 text-rose-300 border-rose-500/30',
    cancelled: 'bg-slate-500/15 text-slate-400 border-slate-500/30',
    inactive: 'bg-slate-500/15 text-slate-400 border-slate-500/30',
    'not submitted': 'bg-slate-500/15 text-slate-400 border-slate-500/30',
    'not allocated': 'bg-slate-500/15 text-slate-400 border-slate-500/30',
